...
void draw(){
  ...
  float rightup = 0 , yellow_rightdown = 0;//往右上，往右下
  ...
  else if(green_ok) stroke(0,255,0);//type3綠色勾勾
  //else if(green_part1) stroke(0,128,0);//暗綠色
  else if(yellow_ok) stroke(255,255,0);//type4黃色倒勾勾
